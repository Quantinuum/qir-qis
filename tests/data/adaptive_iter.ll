...
body:                                       ; preds = %entry
  br label %loop_body
loop_body:                          ; preds = %loop_body, %body
  %b0 = phi i64 [ 1, %body ], [ %b1, %loop_body ]
  %qptr = inttoptr i64 %b0 to %Qubit*
  tail call void @__quantum__qis__cnot__body(%Qubit* null, %Qubit* nonnull %qptr)
  %b1 = add i64 %b0, 1
  %b2 = icmp sle i64 %b1, 4
  br i1 %b2, label %loop_body, label %loop_exit
...
!7 = !{i32 1, !"backwards_branching", i2 1}
