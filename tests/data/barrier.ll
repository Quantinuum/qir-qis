; QIR test for fixed-arity barrier instructions
...
attributes #0 = { "entry_point" "required_num_qubits"="2" "required_num_results"="2" "output_labeling_schema"="labeled" "qir_profiles"="base_profile" }
