...
@2 = internal constant [5 x i8] c"int2\00"
...
continue__4:                                   ; preds = %continue__3, %then__4
  ...
  ; calling an IR defined classical function
  %4 = call i64 @triple(i64 2)
  br label %exit
...
exit:
  ...
  call void @__quantum__rt__int_record_output(i64 %4, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @2, i32 0, i32 0))
  ret i64 0
}
