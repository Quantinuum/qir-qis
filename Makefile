...
.PHONY: fuzz-all
fuzz-all:
	@for target in qir_ll_to_bc validate_qir parse_wasm_functions qir_to_qis get_entry_attributes validate_fixture_with_wasm mutated_fixture_bitcode mutated_fixture_contracts; do \
